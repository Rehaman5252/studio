...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      ...
      >
        <motion.div variants={cardVariants}><ProfileHeader userProfile={userData} /></motion.div>
        <motion.div variants={cardVariants}><StatsSummary userProfile={userData} /></motion.div>
        <motion.div variants={cardVariants}><RewardsSummary userProfile={userData} /></motion.div>
        <motion.div variants={cardVariants}><ReferralCard userProfile={userData} /></motion.div>
        <motion.div variants={cardVariants}><PayoutInfo userProfile={userData} /></motion.div>
