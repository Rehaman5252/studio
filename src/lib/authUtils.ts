...
import { auth, firestore, signInWithGoogle as firebaseSignInWithGoogle } from './firebaseClient';
...
export const registerWithEmail = async (email: string, password: string, name: string) => {
    ...
    await createUserDocument(userCredential.user, { name }); // Ensure Firestore doc is created
