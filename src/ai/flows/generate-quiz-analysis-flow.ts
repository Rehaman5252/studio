...
// The prompt now expects the AI to return a single, raw markdown string. This is more reliable.
...
`,
  config: {
    // Relax safety settings to prevent false positives from blocking the analysis.
    safetySettings: [
