...
export const allFallbackQuestions: FallbackQuestion[] = [
    ...
    // MIXED (10 Questions)
    // =================================================================================
    { id: 'fb_mix_1', format: 'mixed', difficulty: 'Easy', question: 'How many players are there on a standard cricket team?', options: ['9', '10', '11', '12'], correctAnswer: '11', explanation: 'A standard cricket team consists of eleven players on the field.', hint: 'It\'s one more than a standard soccer team.' },
    ...
    { id: 'fb_mix_3', format: 'mixed', difficulty: 'Easy', question: 'What does "LBW" stand for?', options: ['Leg Before Wicket', 'Leg Behind Wicket', 'Long Ball Wide', 'Leg Bye Wicket'], correctAnswer: 'Leg Before Wicket', explanation: 'LBW is a common way for a batsman to be dismissed if the ball strikes their body before the bat.', hint: 'The first word is "Leg".' },
    { id: 'fb_mix_4', format: 'mixed', difficulty: 'Medium', question: 'Who was the first batsman to score 10,000 runs in Test cricket?', options: ['Don Bradman', 'Sunil Gavaskar', 'Viv Richards', 'Allan Border'], correctAnswer: 'Sunil Gavaskar', explanation: 'India\'s Sunil Gavaskar was the first cricketer to reach the milestone of 10,000 runs in Test matches.', hint: 'He was an Indian opening batsman known as the "Little Master".' },
