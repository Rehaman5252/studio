...
const SelectedBrandCardComponent = ({ selectedBrand, onClick }: SelectedBrandCardProps) => {
  return (
    <Card 
        className="rounded-2xl shadow-lg cursor-pointer bg-card/50 hover:bg-secondary/50 transition-colors duration-300 ease-in-out border-primary/20 hover:border-primary/40 transform hover:-translate-y-1"
        onClick={onClick}
        role="button"
