        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li><strong>Consequences of Violation:</strong> Any user found engaging in malpractice, as determined by indcric in its sole discretion, will face penalties including, but not limited to, immediate disqualification from quizzes, forfeiture of all rewards, and permanent suspension of their account.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-4">
          <AccordionTrigger>Rewards & Payout Policy</AccordionTrigger>
          <AccordionContent className="prose dark:prose-invert max-w-none">
            <p>Rewards on indcric are granted as a recognition of a user's superior knowledge, demonstrated by achieving a perfect score in a quiz.</p>
            <ul>
                <li><strong>Nature of Rewards:</strong> Rewards are not "winnings" from a wager, but are prizes awarded for demonstrating exceptional knowledge.</li>
                <li><strong>Eligibility:</strong> Users must have a verified account, including a valid UPI ID, and be in full compliance with our terms to be eligible for rewards.</li>
                <li><strong>Taxation:</strong> All rewards are subject to taxation as per the laws of India, including Tax Deducted at Source (TDS) under Section 194BA of the Income Tax Act, 1961, where applicable. It is the user's responsibility to comply with their personal tax obligations.</li>
                <li><strong>Verification:</strong> We reserve the right to request additional KYC (Know Your Customer) documentation to verify identity and prevent fraud before processing rewards, in accordance with applicable regulations.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
         ...
         <AccordionItem value="item-6">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li><strong>Use of Information:</strong> Your data is used to operate the platform, process rewards, prevent fraud, and enhance user experience. We do not sell or rent your personal data to third parties.</li>
