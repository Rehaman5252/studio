    ...
    return (
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            <p>CricBlitz maintains a strict zero-tolerance policy against any form of malpractice. This is a platform for individual skill, and any attempt to undermine the integrity of the game is a material breach of these terms.</p>
            <ul>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li><strong>Process:</strong> Winnings from perfect scores are credited to the user's CricBlitz account. Withdrawals can be initiated once the user meets the minimum withdrawal threshold, as specified on the platform.</li>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
             ...
             <ul>
                ...
                <li><strong>Policy Changes:</strong> The terms and bonus amounts of the referral program are subject to change at CricBlitz's discretion.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-5">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            <p>The Daily Streak rewards consistent participation on the CricBlitz platform.</p>
             <ul>
        ...
        <AccordionItem value="item-7">
          ...
          <AccordionContent className="prose dark:prose-invert max-w-none">
            <p>CricBlitz uses cookies and similar tracking technologies to ensure our platform functions correctly and to improve your user experience.</p>
            <ul>
                ...
                <li><strong>Your Choices:</strong> While essential cookies are necessary for the platform to work, you may be able to control analytics cookies through your browser settings. Disabling essential cookies may impact your ability to use CricBlitz.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
